...
2. [Create micro services](#u2)
   - [Create Cosmos DB for Orcers Microservice data](#u2a)
...
### <a name="u2a"> Create Cosmos DB for Order Microservice data
   
### <a name="u2b"> Create Function App for Orders Microservice APIs

### <a name="u2c"> Create Cosmos DB for Shipments Microservice data
 
### <a name="u2d"> Create Function App for Shipments Microservice APIs
     
### <a name="u2e"> Create Service Bus for Microservice communications
   
### <a name="u2f"> Create API Management Gateway to front the Microservices
